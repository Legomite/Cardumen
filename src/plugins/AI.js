...
game.module(
        ...
        .body(function() {
            ...
            game.SteeringBehavior = game.Class.extend({
                ...
                seekSin: function(Predator, Prey, maxVelocity, amplitudeX, amplitudeY) {
                    var temp = Prey.position.clone();
                    Predator.position.x = Predator.position.x + amplitudeX;
                    Predator.position.y = Predator.position.y + amplitudeY * (Math.sin(Predator.position.x));
                    temp.subtract(Predator.position);
                    temp.normalize();
                    temp.multiply(maxVelocity);
                    Predator.velocity = temp;
